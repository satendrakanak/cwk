...
export class SendRegistrationOtpEmailProvider {
  ...
  async sendRegistrationOtpEmail(
    ...
    let subject = 'Your CodeWithKasa account verification code';
    let html = `
      <div style="margin:0;padding:32px;background:#f5f7fb;font-family:Arial,sans-serif;color:#111827">
        <div style="max-width:640px;margin:auto;background:#ffffff;border-radius:24px;overflow:hidden;border:1px solid #e5e7eb">
          ...
          <div style="padding:30px">
            <p style="font-size:16px;line-height:1.7;color:#475569">Use this 6-digit code to verify your CodeWithKasa account and complete your registration.</p>
